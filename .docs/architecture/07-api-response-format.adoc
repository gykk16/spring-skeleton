...
| `ApiResource`
| `modules/common-web/src/main/kotlin/io/glory/commonweb/response/resource/ApiResource.kt`

| `Status`
| `modules/common-web/src/main/kotlin/io/glory/commonweb/response/resource/Status.kt`

| `Meta`
| `modules/common-web/src/main/kotlin/io/glory/commonweb/response/resource/Meta.kt`

| `PageResponse`
| `modules/common-web/src/main/kotlin/io/glory/commonweb/response/PageResponse.kt`

| `NoOffsetPageResponse`
| `modules/common-web/src/main/kotlin/io/glory/commonweb/response/NoOffsetPageResponse.kt`
|===
