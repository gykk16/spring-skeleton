...
This skeleton project implements Hexagonal Architecture to achieve:
...
Rather than a strict Hexagonal Architecture with explicit port interfaces, this project adopts a pragmatic **layered multi-module approach with dependency inversion**:
...
@SpringBootApplication(
    scanBasePackages = [
        "io.glory.skeletonapi",
        "io.glory.commonweb",
        "io.glory.infrastructure"
    ]
)
