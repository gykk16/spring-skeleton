...
Create `src/main/kotlin/io/glory/myapplication/client/MyClient.kt`:
...
Create `src/main/kotlin/io/glory/myapplication/client/MyClientConfig.kt`:
...
Create `src/main/kotlin/io/glory/myapplication/service/MyService.kt`:
...
Create `src/main/kotlin/io/glory/myapplication/service/MyDomain.kt`:
...
Create `src/main/kotlin/io/glory/Application.kt`:
...
Create `src/main/kotlin/io/glory/myserviceapp/AppWebConfig.kt`:

[source,kotlin]
----
package io.glory.myserviceapp
...
Create `src/main/kotlin/io/glory/myserviceapp/api/MyController.kt`:

[source,kotlin]
----
package io.glory.myserviceapp.api

import io.glory.common.annoatations.LogResponseBody
import io.glory.commonweb.response.resource.ApiResource
import io.glory.myapplication.service.MyService
