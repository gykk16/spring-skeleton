...
image:https://img.shields.io/badge/Kotlin-2.3.0-7F52FF?logo=kotlin&logoColor=white[Kotlin]
...
│   └── common-application/     # 공통 애플리케이션 (Holiday API)
├── infrastructure/             # DB, Cache, HTTP Client, 외부 서비스
├── bootstrap/                  # Spring Boot 앱 모듈
│   ├── common-api-app/         # 공통 API 서버 (Holiday API)
...
├──────────────────────────────────────────────────────────────┤
│                         Application                          │
│         (common-application: HolidayService)                 │
├────────────────────────────┬─────────────────────────────────┤
