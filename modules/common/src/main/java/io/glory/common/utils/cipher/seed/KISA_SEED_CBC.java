package io.glory.common.utils.cipher.seed;
...
public class KISA_SEED_CBC {
    ...
    // S-BOX
    private static final int SS0[]               = {0x2989a1a8, 0x05858184, 0x16c6d2d4, 0x13c3d3d0, 0x14445054,
            0x1d0d111c,
    ...
    private static final int SS1[]               = {0x38380830, 0xe828c8e0, 0x2c2d0d21, 0xa42686a2, 0xcc0fcfc3,
            0xdc1eced2,
    ...
    private static final int SS2[]               = {0xa1a82989, 0x81840585, 0xd2d416c6, 0xd3d013c3, 0x50541444,
            0x111c1d0d,
    ...
    private static final int SS3[]               = {0x08303838, 0xc8e0e828, 0x0d212c2d, 0x86a2a426, 0xcfc3cc0f,
            0xced2dc1e,
    ...
    private static final void SeedRound(int[] T, int LR[], int L0, int L1, int R0, int R1, int[] K, int K_offset) {
        ...
        T[1] ^= T[0];
        T[1] = SS0[GetB0(T[1]) & 0x0ff] ^ SS1[GetB1(T[1]) & 0x0ff] ^ SS2[GetB2(T[1]) & 0x0ff] ^ SS3[GetB3(T[1])
                & 0x0ff];
        T[0] += T[1];
        T[0] = SS0[GetB0(T[0]) & 0x0ff] ^ SS1[GetB1(T[0]) & 0x0ff] ^ SS2[GetB2(T[0]) & 0x0ff] ^ SS3[GetB3(T[0])
                & 0x0ff];
        T[1] += T[0];
        T[1] = SS0[GetB0(T[1]) & 0x0ff] ^ SS1[GetB1(T[1]) & 0x0ff] ^ SS2[GetB2(T[1]) & 0x0ff] ^ SS3[GetB3(T[1])
                & 0x0ff];
    ...
    private static final void RoundKeyUpdate0(int T[], int[] K, int K_offset, int ABCD[], int KC) {
        ...
        K[K_offset + 0] =
                SS0[GetB0(T[0]) & 0x0ff] ^ SS1[GetB1(T[0]) & 0x0ff] ^ SS2[GetB2(T[0]) & 0x0ff] ^ SS3[GetB3(T[0])
                        & 0x0ff];
        K[K_offset + 1] =
                SS0[GetB0(T[1]) & 0x0ff] ^ SS1[GetB1(T[1]) & 0x0ff] ^ SS2[GetB2(T[1]) & 0x0ff] ^ SS3[GetB3(T[1])
                        & 0x0ff];
        T[0] = ABCD[ABCD_A];
