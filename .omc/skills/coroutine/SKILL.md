...
> **IMPORTANT**: Always use MDC-preserving coroutine functions from `io.glory.common.utils.coroutine`. Raw coroutine builders lose MDC context, which breaks request tracing and logging.
...
import io.glory.common.utils.coroutine.asyncWithMDC
import io.glory.common.utils.coroutine.launchWithMDC
...
```kotlin
import io.glory.common.utils.coroutine.runBlockingOnVirtualThread
import io.glory.common.utils.coroutine.asyncOnVirtualThread
...
```kotlin
import io.glory.common.utils.coroutine.runBlockingOnIoThread
import io.glory.common.utils.coroutine.asyncOnIoThread
...
```kotlin
import io.glory.common.utils.coroutine.retry
...
```kotlin
import io.glory.common.utils.coroutine.retryBlocking
...
```kotlin
import io.glory.common.utils.coroutine.withLogging
