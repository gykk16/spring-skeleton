...
> **IMPORTANT**: Use Value Objects from the `io.glory.common.values` package instead of primitive types.
...
> **Note**: See `modules/common/README.adoc` or skill: `common-module` for detailed usage.
...
> **IMPORTANT**: Use exception classes from the `io.glory.common.exceptions` package for error handling.
